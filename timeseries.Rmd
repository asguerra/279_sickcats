...
plot(Yset, B.starset, type= 'l', lwd=2,col="paleturquoise4",las=1,xlab='Predator mixing, sigma.pm',ylab='Stable equilibria of populations', ylim = c(0,1) )
