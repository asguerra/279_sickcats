...
for(i in 2:length(t.time.set)){
  ...
  #	if(t.set[i] < 3){I.simu4[i-1] <- 0 } else { 
  	#  if(t.set[i] == 3) {I.simu4[i-1] <- 0.2} else { I<- I.simu4[i-1]}}
...
for(i in 2:length(t.time.set)){
 ...
 # if(t.time.set[i] < 3){I.simu5[i-1] <- 0 } else { 
  #	if(t.time.set[i] == 3) {I.simu5[i-1] <- 0.3} else { I<- I.simu5[i-1]}}
