...
As was done in a time series in the study, there was a lag in the introduction of FIV to the cat population. In this case we introduced FIV at time step 3. Still a bit wonky, but we will figure it out to get it to work. 
```{r simu2, eval=FALSE}
B.simu2 <- NaN*t.set 
  B.simu2[1] <- .3
C.simu2 <- NaN*t.set
